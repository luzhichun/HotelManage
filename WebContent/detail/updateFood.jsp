            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
                             ...
                             *<input type="hidden" name="id" value="${f.id}" /></td>
						</tr>
						<tr>
							<td width="80px">菜名</td>
							<td><input type="text" name="foodName" class="InputStyle" value="${f.foodName}"/> *</td>
						</tr>
						<tr>
							<td>价格</td>
						...
						<tr>
							<td>简介</td>
							<td><textarea name="introduce" class="TextareaStyle">${f.remark}</textarea></td>
						</tr>
						<tr>
