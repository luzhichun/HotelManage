...
<script type="text/javascript" src="wdetail/style/js/jquery.js"></script>
<script type="text/javascript" src="wdetail/style/js/page_common.js"></script>
<link href="wdetail/style/css/common_style_blue.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="wdetail/style/css/index_1.css" />
	<style type="text/css">
	* {
		margin: 0px;
		padding: 0px
	...
	<div class="index_all" style="text-align:center;">
		...
		<div id="index_center">
			...
			<div>
				...
				<div class="bg_middle">
					<img
						src="wdetail/style/images/index_menu.gif"
						border="0" usemap="#Map" />
					<map name="Map" id="Map">
